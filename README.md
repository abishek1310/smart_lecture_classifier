...
| SVM TF-IDF+SBERT+CLIP | 0.702 | 0.367 | — |
...
2. **Slide images contribute +0.019 Macro F1** overall. The visual modality helps Worked Example most (+0.034 F1) because whiteboard equations are visually distinctive.

3. **Ensemble achieves best results** (0.762 Macro F1, 0.930 AUC-ROC) by combining complementary strengths of keyword matching (LR), non-linear feature interactions (XGBoost), and semantic+visual understanding (DNN).
